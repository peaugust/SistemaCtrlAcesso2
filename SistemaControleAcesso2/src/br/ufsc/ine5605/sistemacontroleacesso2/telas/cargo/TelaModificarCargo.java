 ...
 * @author 03851937007
 */
public class TelaModificarCargo extends JFrame {
    private JLabel labelModificar;
    private JTextField campoModificar;
    ...
    private void definirGUI () {
        ...
        this.labelModificar = new JLabel("Insira o código do cargo a ser alterado:     ");
        ...
        painel.add(this.labelModificar, constraints);
      ...
      //Definir o Rotulo do dia do nascimento:
        ...
        this.campoModificar = new JTextField(15);
        ...
        painel.add(this.campoModificar, constraints);
        ...
        public void actionPerformed(ActionEvent evento) {
        	 if (evento.getSource().equals(botaoCarregar)) {
                 ...
                 if(cargo != null){
		             ...
		             try {
		                 //Chama o metodo de modificar funcionario (joga execoes):
		                 if(cargo instanceof CargoComAcesso){
		                	 CargoComAcesso cargoComAcesso= (CargoComAcesso) cargo;
		                	 
		                	 campoCodigo.setText(cargo.getCodigo());
			                 campoNome.setText(cargo.getNome());
				             Calendar horario= cargoComAcesso.getArrayComHorarios().get(0);
			                 campoHoraInicio.setText(String.valueOf(horario.get(Calendar.HOUR_OF_DAY)));
			                 campoMinutoInicio.setText(String.valueOf(horario.get(Calendar.MINUTE)));
			                 horario= cargoComAcesso.getArrayComHorarios().get(1);
			                 campoHoraFim.setText(String.valueOf(horario.get(Calendar.HOUR_OF_DAY)));
			                 campoMinutoFim.setText(String.valueOf(horario.get(Calendar.MINUTE)));
			                 horario= cargoComAcesso.getArrayComHorarios().get(2);
			                 campoSHoraInicio.setText(String.valueOf(horario.get(Calendar.HOUR_OF_DAY)));
			                 campoSMinutoInicio.setText(String.valueOf(horario.get(Calendar.MINUTE)));
			                 horario= cargoComAcesso.getArrayComHorarios().get(3);
			                 campoSHoraFim.setText(String.valueOf(horario.get(Calendar.HOUR_OF_DAY)));
			                 campoSMinutoFim.setText(String.valueOf(horario.get(Calendar.MINUTE)));		
		                 }else{
		                	 campoCodigo.setText(cargo.getCodigo());
			                 campoNome.setText(cargo.getNome());
		                 }
                     ...
                     JOptionPane.showMessageDialog(null, "O cargo não existe.");
                 }
        	
        	//Quando o botao de crair for pressionado:
        	}else if (evento.getSource().equals(botaoCriar)) {
                ICargo cargo= ControladorGeral.getInstance().getControladorCargo().findCargoByCodigo(campoModificar.getText());
           
                try {
                    //Chama o metodo de modificar funcionario (joga execoes):
                    if(cargo instanceof CargoComAcesso){
                    	ControladorGeral.getInstance().getControladorCargo().modificarCargo(campoModificar.getText(), criarEnvelope());

                    }else{
                    	ControladorGeral.getInstance().getControladorCargo().modificarCargo(campoModificar.getText(), campoCodigo.getText(), campoNome.getText());
                    }
