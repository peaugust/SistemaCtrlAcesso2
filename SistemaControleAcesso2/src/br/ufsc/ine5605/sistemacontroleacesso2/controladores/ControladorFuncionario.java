...
//    }
    ...
    public void modificarFuncionario (Funcionario funcionarioParaModificar, EnvelopeFuncionario envelope) {
        ...
        if (envelope == null) {
            ...
            //Verificar se jah existe a mesma matricula:
            for (Funcionario funcionarioLista : this.mapeador.getFuncionarios()) {
                //Caso for o mesmo Funcionario:
                if (funcionarioLista.equals(funcionarioParaModificar)) {  
                    //Nao verificar
                } else { //Se não for:
            ...
            //Criar um novo Funcionario e substituir o antigo na HashMap:
            Funcionario funcionarioAtualizado = new Funcionario(envelope.numeroDeMatricula, envelope.nome, envelope.telefone, 
                                                                envelope.salario, envelope.cargo, dataDeNascimento);
            this.mapeador.put(funcionarioAtualizado);
        }
    }
